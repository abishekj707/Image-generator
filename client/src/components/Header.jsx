...
const Header = () => {
  ...
  return (
    ...
    >
        ...
        >Unleash your creativity with AI. Turn
            your imagination into visual art in seconds - just type, and watch
            the magic happen.
        </motion.p>
    ...
    className='flex flex-wrap justify-center mt-16 gap-3'>
        {Array(6).fill('').map((items, index)=>{
            ...
            duration-300 cursor-pointer max-sm:w-10" width={70}
    ...
    className='text-neutral-600 mt-2'>Generate images from imagify</motion.p>
