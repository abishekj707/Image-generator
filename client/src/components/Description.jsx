...
const Description = () => {
  return (
    ...
    <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        ...
        xl:w-96 rounded-lg'/>
        <div>
        <h2 className='text-3xl font-medium m-w-lg mb-4'>Introducing the AI-Powered Text to Image Generator</h2>
        ...
        <p className='text-gray-600'>Simply type in a text prompt, and our cutting edge AI will generate
            ...
            be visualized effortlessly. Powered by advanced AI technology,
